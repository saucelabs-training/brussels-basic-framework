# Basic Framework Walkthrough

This open source code is for use in workshops.

See [LICENSE](https://github.com/saucelabs-training/brussels-basic-framework/LICENSE.md) file for details.
...
1. [Install Git](https://github.com/saucelabs-training/brussels-basic-framework#install-git)
    * [Mac](https://github.com/saucelabs-training/brussels-basic-framework#macosx-screen-cast)
    * [Windows](https://github.com/saucelabs-training/brussels-basic-framework#windows-screen-cast)
2. [Install IntelliJ](https://github.com/saucelabs-training/brussels-basic-framework#install-intellij)
    * [Mac](https://github.com/saucelabs-training/brussels-basic-framework#macosx-screen-cast-1)
    * [Windows](https://github.com/saucelabs-training/brussels-basic-framework#windows-screen-cast-1)
3. [Install JDK](https://github.com/saucelabs-training/brussels-basic-framework#install-the-java-developers-kit)
    * [Mac](https://github.com/saucelabs-training/brussels-basic-framework#macosx-screen-cast-2)
    * [Windows](https://github.com/saucelabs-training/brussels-basic-framework#windows-screen-cast-2)
4. [Set up Project](https://github.com/saucelabs-training/brussels-basic-framework#set-up-this-project-in-intellij)
    * [Mac](https://github.com/saucelabs-training/brussels-basic-framework#macosx)
    * [Windows](https://github.com/saucelabs-training/brussels-basic-framework#windows)
...
1. Downloading the Project Files
    * Go to [https://github.com/saucelabs-training/brussels-basic-framework/releases](https://github.com/saucelabs-training/brussels-basic-framework/releases).
